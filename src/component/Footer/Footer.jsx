      ...
      <footer className="bg-vault-black py-16 px-6 md:px-12 border-t border-white/10 text-xs text-vault-muted">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-4 space-y-4">
            <a href="#root" className="text-2xl font-serif tracking-widest font-bold uppercase text-vault-cream block">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="flex space-x-5 text-base text-vault-cream pt-2">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-vault-accent transition"><i className="fa-brands fa-instagram"></i></a>
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="hover:text-vault-accent transition"><i className="fa-brands fa-pinterest"></i></a>
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:text-vault-accent transition"><i className="fa-brands fa-x-twitter"></i></a>
              <a href="https://vimeo.com" target="_blank" rel="noopener noreferrer" aria-label="Vimeo" className="hover:text-vault-accent transition"><i className="fa-brands fa-vimeo-v"></i></a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-white/5 pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] uppercase font-mono tracking-wider space-y-4 sm:space-y-0">
          ...
          <div className="flex space-x-6">
            <a href="#root" className="hover:text-white transition">Privacy Policy</a>
            <a href="#root" className="hover:text-white transition">Terms of Access</a>
            <a href="#root" className="hover:text-white transition">Cookies Preferences</a>
          </div>
        </div>
      </footer>
    </div>
